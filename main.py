...
# ── Export de Odoo: RETIRADO (2026-07-12) por seguridad ──
#    Exponía toda la historia del negocio (ventas, compras, contactos, rotación)
#    tras un único secreto de servidor. Esa data ya quedó importada a Zentral,
#    así que el endpoint se elimina: GET /api/_odoo-export ahora responde 404.
#    Si algún día se necesita re-extraer, restaurar desde el historial de git.
